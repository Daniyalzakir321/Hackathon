                        ...
                        <TouchableOpacity activeOpacity={0.8} key={i} onPress={() => {
                            ...
                            <View style={{
                                ...
                                <View>
                                    ...
                                    <Text style={{ fontSize: 15, textTransform: 'capitalize', paddingTop: 2 }}><Fontisto name="person" size={11.3} color="black" />  Job Name:    {d.jn}</Text>
                                    <Text style={{ fontSize: 15, textTransform: 'capitalize', paddingTop: 2 }}><FontAwesome name="pencil" size={11.3} color="black" />  Job Descri.:  {d.jd}</Text>
                                    <Text style={{ fontSize: 15, textTransform: 'capitalize', paddingTop: 2 }}><FontAwesome name="money" size={11.3} color="black" />  Job Salary:   {d.js}</Text>
                                    <Text style={{ fontSize: 15, textTransform: 'capitalize', paddingTop: 2 }}><FontAwesome name="mortar-board" size={11.3} color="black" /> Job Criteria:  {d.jc}</Text>
                                    <Text style={{ fontSize: 15, textTransform: 'capitalize', paddingTop: 2 }}><Fontisto name="email" size={11.3} color="black" />  Email:             {d.email}</Text>
                                    <Text style={{ fontSize: 15, textTransform: 'capitalize', paddingTop: 2 }}><MaterialCommunityIcons name="email" size={11.3} color="black" />  Last Date:     {d.vdateTime}</Text>
